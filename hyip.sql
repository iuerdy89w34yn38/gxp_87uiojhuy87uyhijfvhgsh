...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 12, 2021 at 03:57 AM
...
(1, 'Supper Admin', 'admin@wilcode.com', 'admin', NULL, '5eea09e65cefb1592396262.jpg', '$2y$10$lK9hjtWNBrVIpIKCeh8zteXn1kTzZ4O70o6JTU6UfmOWtjTxsti4a', NULL, '2020-07-25 01:35:29');
...
INSERT INTO `deposits` (`id`, `user_id`, `plan_id`, `method_code`, `amount`, `method_currency`, `charge`, `rate`, `final_amo`, `detail`, `btc_amo`, `btc_wallet`, `trx`, `try`, `status`, `admin_feedback`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, 1003, '800.00000000', '$', '9.00000000', '1.00000000', '809.00000000', NULL, '0', '', 'JSP72S4NT7OK', 0, 2, NULL, '2021-02-07 05:11:31', '2021-02-07 05:11:59');
...
CREATE TABLE IF NOT EXISTS `email_sms_templates` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `email_sms_templates_act_unique` (`act`)
...
CREATE TABLE IF NOT EXISTS `frontends` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `frontends_key_index` (`data_keys`)
...
(154, 'banner.content', '{\"has_image\":\"1\",\"heading_w\":\"Invest for Future\",\"heading_c\":\"and Make Fast Money\",\"sub_heading\":\"Invest in an Industry Leader, Professional, and Reliable Company.\",\"button_name\":\"Sign Up\",\"button_link\":\"register\",\"image\":\"5fce371bad7db1607350043.jpg\"}', '2020-12-07 14:07:23', '2021-02-12 04:27:27'),
...
(176, 'how_work.content', '{\"has_image\":\"1\",\"heading_w_1\":\"How\",\"heading_c\":\"Global Exchange Pay Investment\",\"heading_w_2\":\"Works\",\"sub_heading\":\"Get involved in our tremendous platform and Invest. We will utilize your money and give you profit in your wallet automatically.\",\"image\":\"5fce39883b22c1607350664.jpg\"}', '2020-12-07 14:17:44', '2021-02-11 04:44:34'),
...
(206, 'why_choose.content', '{\"has_image\":\"1\",\"heading_w\":\"Why Choose\",\"heading_c\":\"Global Exchange Pay Investment\",\"sub_heading\":\"Our goal is to provide our investors with a reliable source of high income, while minimizing any possible risks and offering a high-quality service.\",\"image\":\"5fce3cf364ca21607351539.jpg\"}', '2020-12-07 14:32:19', '2021-02-11 04:44:01'),
...
(31, 1003, 'hamza_pervaiz', '601f68348a3a61612671028.png', 'HAMZA PERVAIZ', 1, '[]', '[]', 0, NULL, 'ytfghjiuygf', '[]', '2021-02-07 05:10:29', '2021-02-07 05:10:58');
...
(1, 'HAMZA PERVAIZ', '$', '', 1003, 'hamza_pervaiz', '10.00000000', '10000.00000000', '1.00', '1.00000000', '1.00000000', '601f68348a3a61612671028.png', '[]', '2021-02-07 05:10:29', '2021-02-07 05:10:29');
...
(6, 'Cobra', '1000', '1000', '1000', '10', 0, '1', 1, 1, 1, 0, '150', '2018-12-06 01:58:48', '2020-05-03 08:17:57'),
(7, 'Elephant', '500', '700', '0', '1.1', 0, '24', 1, 1, 1, 0, '50', '2018-12-06 01:59:22', '2020-05-03 08:17:31'),
(8, 'Crown', '200', '5000', '0', '3.5', 1, '1', 1, 0, 0, 1, '0', '2018-12-09 04:27:33', '2020-05-03 08:17:21'),
(9, 'Silver', '500', '500', '500', '5', 1, '24', 1, 1, 0, 0, '25', '2018-12-09 04:29:15', '2020-05-03 08:18:18'),
(10, 'Black Horse', '500', '5000', '0', '5', 1, '168', 1, 1, 0, 0, '40', '2018-12-10 00:00:24', '2020-05-03 08:18:42'),
(11, 'Life Time', '100', '200', '0', '0.2', 1, '24', 1, 1, 0, 1, '0', '2019-01-22 22:07:24', '2020-05-03 08:31:27'),
(12, 'Gold', '200', '200', '200', '2', 0, '168', 1, 0, 1, 0, '1', '2019-12-18 14:04:20', '2020-08-27 13:29:06'),
(13, 'Platinum', '100', '3000', '0', '6', 0, '24', 1, 0, 1, 0, '1', '2019-12-18 14:08:27', '2019-12-18 14:23:43'),
(14, 'Slivesto', '200', '200', '200', '6', 1, '168', 1, 1, 1, 0, '5', '2019-12-19 10:08:17', '2020-08-27 13:27:09');
...
CREATE TABLE IF NOT EXISTS `plugins` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `plugins_act_unique` (`act`)
...
(3, 'custom-captcha', 'Custom Captcha', 'Just Put Any Random String', 'customcaptcha.png', NULL, '{\"random_key\":{\"title\":\"Random String\",\"value\":\"SecureString\"}}', 'na', 0, NULL, '2019-10-18 23:16:05', '2021-02-07 05:00:58'),
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `email`, `mobile`, `ref_by`, `password`, `image`, `address`, `deposit_wallet`, `interest_wallet`, `status`, `ev`, `sv`, `ver_code`, `ver_code_send_at`, `ts`, `tv`, `tsc`, `provider`, `provider_id`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, NULL, NULL, 'hamza56', 'hamzapervaiz5@gmail.com', '93', NULL, '$2y$10$s5.oWMvQRL5qHxl.50XvGueLpm7bc7ruW2.Bzzwzq.e3FIkad92Cu', NULL, '{\"address\":\"\",\"state\":\"\",\"zip\":\"\",\"country\":\"Afghanistan\",\"city\":\"\"}', '0.00000000', '0.00000000', 1, 1, 1, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, '2021-02-07 05:05:36', '2021-02-07 05:05:36');
...
(1, 1, '::1', ' - -  -  ', 'Chrome', 'Windows 10', '', '', '', '', '2021-02-07 05:05:36', '2021-02-07 05:05:36');
...
CREATE TABLE IF NOT EXISTS `withdrawals` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `withdrawals_trx_unique` (`trx`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
