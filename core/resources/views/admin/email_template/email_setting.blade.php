                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row mt-4 d-none configForm" id="smtp">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('e.g. smtp.googlemail.com')" name="host" value="{{ $general_setting->mail_config->host ?? '' }}"/>
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                <label class="font-weight-bold">@lang('Driver')</label>
                                <input type="text" class="form-control" placeholder="@lang('e.g. smtp')" name="driver" value="{{ $general_setting->mail_config->driver ?? '' }}"/>
                            </div>
                            <div class="form-group col-md-2">
                                <label class="font-weight-bold">@lang('Encryption')</label>
                                <input type="text" class="form-control" placeholder="@lang('e.g. ssl')" name="enc" value="{{ $general_setting->mail_config->enc ?? '' }}"/>
                            </div>
                            <div class="form-group col-md-6">
