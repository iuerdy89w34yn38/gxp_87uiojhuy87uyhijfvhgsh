...
@endphp
 <!-- hero start -->
    <section class="hero bg_img" data-background="{{ getImage('assets/images/frontend/banner/'.@$banner->data_values->image,'1920x896') }}" style="padding-top: 150px">
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
          ...
          <div class="col-lg-3">
            <br>
            <br>
            <img src="https://shogbtc.com/assets/images/one.gif">
          </div>
          <div class="col-lg-4">
            <br>
            <br>
            
            <img src="https://thumbs.gfycat.com/SmoggyJealousEidolonhelvum-size_restricted.gif">
          </div>
        </div>
      </div>
    </section>
