              ...
              <div class="account-card__body">
                <form action="{{ route('user.login')}}" class="mt-4" method="post" onsubmit="return submitUserForm();">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="username" placeholder="@lang('Enter user name')">
                  </div>
                  <div class="form-group">
                    <label>@lang('Password')</label>
                    <input type="password" type="text" class="form-control" name="password" placeholder="@lang('Enter password')">
                  </div>
