...
<head>
  ...
  <script>var smwPathToAssets = '/hyip/assets';</script>
  ...
  <script src="{{ asset('assets/psmw/js/app.min.js') }}"></script>


  <link rel="stylesheet" href="{{ asset('assets/css/custom.css') }}">


<link rel="stylesheet" type="text/css" href="{{ asset('assets/psmw/css/style.css') }}" />

</head>
  <body>
@php echo  fbComment() @endphp
 
<?php require_once 'assets/psmw/shortcode.php'; ?>
  ...
  <header class="header">
    <div class="header__bottom">
      <div class="container">
<?php shortcode(['type' => 'ticker', 'symbol' => 'BTC-USD,ETH-USD,ADA-USD,XRP-USD,TSCO.L,AAPL,MSFT,TSLA,GOOG,CS,JPM,GE,DB', 'template' => 'basic', 'speed' => 20000, 'direction' => 'left', 'pause' => TRUE]); ?>
