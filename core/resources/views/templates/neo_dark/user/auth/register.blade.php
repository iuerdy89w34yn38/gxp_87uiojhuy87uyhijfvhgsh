                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6 form-group ">
                                    ...
                                    <input type="text" name="firstname" id="firstname"
                                           placeholder="{{ trans('First Name') }}" value="{{ old('firstname') }}">
                                </div>
                                ...
                                <div class="col-lg-12 form-group">
                                    ...
                                    <input type="text" name="email" id="signup_email"
                                           placeholder="{{trans('Email Address') }}" value="{{old('email')}}">
                                </div>


                                <div class="col-lg-6 form-group">
                                    <label>{{ trans('Password') }}</label>
                                    <input type="password" name="password" id="signup_pass" placeholder="@lang('Password')">
                                </div>
                                ...
                                @php
                                  ...
                                  @endphp
                                <div class="col-lg-12 form-group">
                                    <input type="checkbox" name="terms"> <span class="f-size-14 ml-2">@lang('I agree with') @foreach($links as $link) 
