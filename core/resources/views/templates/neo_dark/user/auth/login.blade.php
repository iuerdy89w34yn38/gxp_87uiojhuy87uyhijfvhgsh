                    ...
                    <div class="signin-form-area">
                        ...
                        <form class="signin-form" action="{{ route('user.login')}}" method="post"  onsubmit="return submitUserForm();">
                            ...
                            <div class="form-group custom-form-field">
                                ...
                                <input type="text" name="username" id="signin_name" placeholder="{{trans('username')}}" value="{{ old('username') }}" >
                            </div>

                            <div class="form-group custom-form-field">
                                <i class="fa fa-lock"></i>
                                <input type="password" name="password"  id="signin_pass"  placeholder="{{trans('password')}}" required autocomplete="current-password">
                            </div>
