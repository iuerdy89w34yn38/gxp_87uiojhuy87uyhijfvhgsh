...
<div id="<?php print $widgetId?>" class="<?php print $widgetClass?>" <?php print $widgetDataAttributes?>>
  <?php foreach ($widgetSymbols as $symbol): ?>
    <span class="smw-ticker-single-container">
      ...
      <span class="smw-market-data-field smw-change-indicator" data-symbol="<?php print $symbol ?>" data-field="quote.regularMarketChange"></span>
      <span class="smw-market-data-field smw-change-indicator" data-symbol="<?php print $symbol ?>" data-field="quote.regularMarketChangePercent"></span>
    </span>
  <?php endforeach;?>
</div>
<script>
