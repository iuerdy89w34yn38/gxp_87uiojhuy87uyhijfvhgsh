  ...
  <?php foreach ($widgetSymbols as $symbol): ?>
    <span class="smw-ticker-single-container">
      <span class="smw-first-line">
          ...
          (<span class="smw-market-data-field" data-symbol="<?php print $symbol ?>" data-field="virtual.symbol"></span>)
      </span>
      <span class="smw-second-line">
        ...
        <span class="smw-market-data-field smw-change-indicator" data-symbol="<?php print $symbol ?>" data-field="quote.regularMarketChange"></span> (<span class="smw-market-data-field smw-change-indicator" data-symbol="<?php print $symbol ?>" data-field="quote.regularMarketChangePercent"></span>)
      </span>
    </span>
  <?php endforeach;?>
</div>
