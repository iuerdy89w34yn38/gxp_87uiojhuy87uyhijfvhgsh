  ...
  <table>
    ...
    <?php foreach ($widgetSymbols as $i => $symbol): ?>
      ...
      <?php foreach ($widgetFields as $code):?>
        ...
        <?php else:?>
        <td>
          <span class="smw-market-data-field <?php print in_array($code,['quote.regularMarketChange','quote.regularMarketChangePercent'])?'smw-change-indicator':''?>" data-symbol="<?php print $symbol ?>" data-field="<?php print $code?>"></span>
        </td>
        <?php endif?>
        <?php endforeach?>
      </tr>
